export const en = {
  ...
  hero: {
    greeting: "Hi all, I'm",
    name: "Lucas",
    rolePrefix: "Marketing Professional turned",
    roleSuffix: "Agentic Developer",
    languages: "Languages: Native Portuguese, Fluent Spanish, Fluent English",
    executiveSummaryTitle: "Executive Summary",
    description: "A passionate Marketing and Communication Professional experienced in developing strategies that strengthen brands and boost audience engagement. Fluent in three languages, I have collaborated with professionals across five continents. I excel at adapting to diverse cultural landscapes and leveraging insights to drive impactful results.\n\nAs a passionate side pursuit, I've developed advanced skills as an Agentic Developer. I leverage my deep understanding of business strategy to architect innovative, AI-driven software. By applying context engineering to AI models, I bridge the gap between creative concepts and functional code, building highly interactive applications with unprecedented velocity. This unique blend of strategic communication and technical agility allows me to deliver cutting-edge results across both domains."
  },
  skills: {
    title: "Technical Arsenal",
    subtitle: "Click to expand categories and explore the tools I use to execute agentic development.",
  ...
  experience: {
    ...
    priorTitle: "Prior Experiences",
    jobs: [
      {
        title: "Marketing Director",
        company: "Law Office of Jennifer F. Novak",
        duration: "2025 - Current",
        description: "Led the organization's full digital strategy, delivering major visibility and engagement gains through data-driven campaigns and SEO. Drove 925% blog-impression growth, 3,900%+ LinkedIn follower growth, and 684% YouTube view expansion while launching multilingual (Spanish) channels and managing end-to-end video production. Oversaw content across all platforms, boosted Instagram reach by 6,300% and Facebook followers by 385%, and strengthened website performance through SEO, newsletters, competitor insights, and persona development.",
        technologies: ["Digital Strategy", "SEO", "Content Marketing", "Social Media", "Video Production"],
        logo: "/images/jennifer-novak-logo.png",
        location: "Los Angeles, California, United States"
      },
      {
        title: "Public Relations and Marketing Specialist",
        company: "Robert Half",
        duration: "2021 - 2025",
        description: "Led content strategy, blog management, and executive branding initiatives. Managed multilingual content production and corporate podcasts. Developed performance reports and strategic recommendations.",
        technologies: ["Content Strategy", "SEO", "Podcasting", "Branding", "Analytics"],
        logo: "/images/a629e0a7-48cb-41ae-a445-fcff2a8cf9d0.png",
        location: "São Paulo, Brazil"
      },
      {
        title: "South America Content Editor",
        company: "Ford Motor Company",
        duration: "2015 - 2021",
        description: "Managed South America's editorial calendar and content distribution strategy. Achieved significant cost reduction through video production internalization. Led regional communications across multiple countries.",
        technologies: ["Content Management", "Video Production", "Media Relations", "Brand Management"],
      ...
      },
      {
        ...
        company: "UZ Games",
        duration: "2012 - 2015",
        description: "Led strategic and operational management of the franchise. Implemented successful customer loyalty strategies and marketing campaigns. Managed financial planning and sales team supervision.",
        technologies: ["Marketing Strategy", "Customer Loyalty", "Sales Management", "Financial Planning"],
      ...
      },
      {
        ...
        company: "SmartPR",
        duration: "2009 - 2011",
        description: "Developed communication strategies for technology, telecommunications, and financial sector clients. Managed press relations and produced analytical performance reports.",
        technologies: ["PR Strategy", "Media Relations", "Performance Analysis", "Corporate Communications"],
    ...
    priorJobs: [
      ...
      },
      {
        ...
        company: "Jovem Pan (Radio Station)",
  ...
  education: {
    ...
    schools: [
      {
        ...
        degree: "Postgraduate Degree, Market Communication",
        period: "2006 - 2007",
    ...
    certifications: [
      ...
      {
        name: "Python - Fundamento para Análise de Dados",
  ...
  caseStudies: {
    title: "Agentic Case Studies",
    subtitle: "A showcase of digital products, utilities, and immersive retro-tech experiences built entirely through structured context engineering.",
    conceptLabel: "The Concept:",
    logicLabel: "The Logic:",
    techLabel: "Tech Stack:",
    addYoutubeId: "Add YouTube ID",
    projects: [
      {
      ...
      },
      {
            ...
            "concept": "A dynamic, immersive web ecosystem designed to simulate a live Heavy Metal & Rock TV broadcast. The goal was to create a deeply atmospheric, \"futuristic HUD\" aesthetic (think Cyberpunk meets MTV), giving the user a persistent, uninterrupted visual and audio streaming experience complete with live tickers and playlist databases.",
            "logicWorkflow": "I approached this by defining the visual interface and grid constraints first, as the aesthetic *was* the core feature. I directed the AI to build a CSS Grid overlay over a borderless YouTube iframe to hide default playback controls and create a custom \"TV frame.\" Once the frontend structure and neon color tokens (magenta, cyan, green) were in place, I prompted the AI to construct the backend logic: an interconnected `playlist_db.js` system that seamlessly transitions video content to mimic live TV broadcasting.",
            "logicTriumphs": "The AI struggled with maintaining a seamless visual experience when transitioning between video embeds, often exposing black bars or default YouTube UI elements that broke the immersion. I intervened by steering the logic towards a \"scale-and-bleed\" CSS wrapper (`.iframe-wrapper`) that forcefully pushed default UI boundaries out of the visible viewport, tricking the browser into displaying a pristine, unbranded video stream under our custom HUD.",
            "tech": "- **Frontend:** Vanilla HTML5, CSS3, JavaScript - **Typography:** Orbitron, Syne, Inter (Google Fonts) - **Platforms:** Web, Mobile-Responsive",
            "result": "*[Insert Video/GIF here: A short recording showing the sleek dark-mode UI, the pulsing neon ambient glow, and the TV broadcast interface.]*"
      },
      {
            "title": "LPRadio (Immersive Radio Spinoff)",
            "category": "Creative Technology",
            "logoUrl": "/images/projects/lpradio.png",
            "youtubeId": "isjWW9iKXsY",
            "concept": "Conceived as an audio-focused spinoff of the LPTV ecosystem, LPRadio strips away the TV broadcasts' video elements to focus entirely on an immersive radio experience. Utilizing the exact same underlying playlist technology, it creates an atmospheric audio player with a focus on frequency visualizers rather than moving pictures.",
            "logicWorkflow": "To build this spinoff, I reused the robust `playlist_db.js` architecture developed for LPTV. I instructed the AI to strip out the heavy video-rendering iframe logic and replace it with a lightweight audio-only player. The visual real estate was re-allocated to a dynamic frequency visualizer that pulses in time with the music, maintaining the \"Cyberpunk meets MTV\" aesthetic but tailored for a pure audio experience.",
            "logicTriumphs": "Adapting the video playlist system to an audio-only format initially caused synchronization issues with the new visualizer components. I intervened by rewriting the event listeners so the frequency bars accurately reflected the audio data stream in real-time, ensuring the visual feedback felt directly connected to the music.",
  ...
  contact: {
    title: "Contact Me",
    subtitle: "Feel free to reach out, have a question, or just want to connect.",
    email: "Email",
    phone: "Phone",
  ...
  footer: {
    ...
    builtWith: "Built with React, Tailwind CSS, and passion.",
    links: {
      skills: "Skills",
      experience: "Experience",
